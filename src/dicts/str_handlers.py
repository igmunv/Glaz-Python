...
def help_launcher(lang_lib, data=None):
    ...
    if len(mandatory_variables) > 0:
        ...
        for var in mandatory_variables:
            result += f"{ddm.DESIGNATIONS['border']} {var}: MANDATORY : {module.variables[var]['description']}\n"
    ...
    if len(optional_variables) > 0:
        ...
        for var in optional_variables:
            result += f"{ddm.DESIGNATIONS['border']} {var}: OPTIONAL : {module.variables[var]['description']}\n"
